...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "rampravesh164191@gmail.com",
    href: "mailto:rampravesh164191@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 7838771118",
    href: "tel:+91 7838771118",
  },
  {
    icon: MapPin,
    label: "Location",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-(--color-surface) rounded-xl border border-border focus:border-(--color-primary) focus:ring-1 focus:ring-(--color-primary) outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-(--color-surface) rounded-xl border border-border focus:border-(--color-primary) focus:ring-1 focus:ring-(--color-primary) outline-none transition-all resize-none"
                />
              </div>
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            {/* Availability Card */}
            <div className="glass rounded-3xl p-8 border border-(--color-primary/30)">
